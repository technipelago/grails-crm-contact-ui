...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'crmPerson.label', default: 'Person')}"/>
    <title><g:message code="crmContact.create.person.title" args="[crmContact.parent ?: entityName]"/></title>
...
<crm:header title="crmContact.create.person.title" args="[crmContact.parent ?: entityName]"/>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4">
                            <div class="row-fluid">
                                ...
                                <f:field property="email" input-class="span8"/>
                            </div>
                        </div>
